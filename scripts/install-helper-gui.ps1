...
Add-Label $tabCloud (Txt "worker_url") 30 180
...
"@
    ...
    $log.AppendText("web/.env, templates/groups.csv, templates/members.csv, worker/wrangler.toml 파일을 만들었습니다.`r`n")
