...
function home() {
  ...
  document.querySelectorAll('.tool').forEach((b) => b.onclick = () => ({
    pin: pinChangeScreen, elderpin: elderPinScreen, notice: noticeListScreen, duty: dutyEditScreen, pdf: pdfPickScreen,
    reports: reportDashScreen, board: boardEditScreen,
    talks: talksScreen, talkassign: talkAssignScreen, visits: visitsScreen, secretary: secretaryScreen,
    members: memberGroupPickScreen, roster: rosterScreen,
    contacts: contactsScreen, publications: publicationsScreen,
